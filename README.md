...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=rohithb01&color=00d4aa" alt="Profile views" />
</p>

<p align="center">
  <a href="https://rohith-portfolio-henna.vercel.app/" target="_blank">
    <img src="https://img.shields.io/badge/Portfolio-rohith--portfolio-00d4aa?style=for-the-badge&logo=vercel&logoColor=white" alt="Portfolio"/>
  </a>
  &nbsp;
  <a href="https://www.linkedin.com/in/rohithb2001/" target="_blank">
...
> Results-driven ML Engineer specializing in **Generative AI**, **RAG-based systems**, and **End-to-End ML Pipelines**. Dual Microsoft Azure Certified (AI-102 & DP-100). Based in **Bengaluru, India**.
>
> 💼 **Open to ML Engineer / AI Engineer roles in Bengaluru**

---

### 🧠 About Me

- 🎓 Pursuing **M.Tech in Artificial Intelligence** at REVA University (2023–2025)
...
- **96% ROC-AUC** • **92% Recall** on 284,807 transactions
- Handled extreme class imbalance (0.17%) using SMOTE
- Deployed as interactive **Streamlit** app
- **Tools:** Python, Scikit-learn, Pandas, Random Forest, Streamlit
...
- Queries across **500+ page PDFs** using RAG + FAISS
- **~40% better** retrieval vs keyword search
- Sub **3-second** response latency
- **Tools:** LangChain, LLMs, FAISS, RAG, Azure AI, Streamlit

---

### 📊 Customer Churn Prediction
> ML analytics with Power BI retention dashboard

- **88% ROC-AUC** • **85% Recall** on 7,043 customer records
- Projected **12–15% retention improvement**
...
<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=rohithb01&theme=radical" alt="GitHub Streak"/>
</p>
